        ...
        <div class="mx-auto w-full px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
            ...
            <div class="flex gap-x-6 flex-col md:flex-row">
                ...
                <div class="rightside md:w-1/2 w-full flex-col flex">
                    ...
                    @if(Auth::user() != null && $post->isEditable(Auth::user()))
                        <a
                            id="button"
                            href="{{ route('posts.edit' , ['post' => $post->id]) }}"
                            class="mt-auto text-center w-full px-6 py-3 mt-3 text-lg text-white transition-all duration-150 ease-linear rounded-lg shadow outline-none bg-pink-500 hover:bg-pink-600 hover:shadow-lg focus:outline-none"
                        >
                            แก้ไขคำร้องเรียน
                        </a>
                    @endif
